...
// 전처리기(preprocessor) : 컴퓨터의 처리에 있어서 중심적인 처리를 수행하는 부분을
// 위해 먼저 실행되는 프로그램을 의미합니다.
...
int main()
{
	...
	int radius = 2; // int는 정수를 표년하는 데이터입니다.
